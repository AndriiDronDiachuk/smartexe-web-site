$(document).ready(function ($) {
    ...
    var library = {
        ...
        '../about_us/about_us.html': {
            ...
            'Since 2004, we’ve worked with a variety of companies requiring high-tech, innovative solutions. We’ve helped companies of all sizes, from small start-ups to well-established enterprises. The verticals we serve are also diverse, and our technologies has grown over time to include scalable web technologies, mobile applications, product design, cloud technologies, and quality assurance. To put it concisely: we’ll pair your ideas with our technical technologies to help you and your company succeed. Whether we’re designing a product from the ground up or managing a project segment, our goal is to see both your ideas and your profits spring to life. ' +
